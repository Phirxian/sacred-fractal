...
/*
    ...
    ImVec2 operator+(const ImVec2& other) const { return ImVec2(x + other.x, y + other.y); }
    ImVec2& operator+=(const ImVec2& other) { x+=other.x; y+=other.y; return *this; }
    ImVec2 operator+(const float v) const { return ImVec2(x + v, y + v); }
    ImVec2& operator+=(const float v) { x+=v; y+=v; return *this; }
...
struct ImGuiIO
{
    ...
    struct RenderDrawLists { virtual void operator() (ImDrawData* data) = 0; };
    RenderDrawLists *RenderDrawListsFn;
