...
#define NO_IMGUIHELPER_SERIALIZATION_SAVE
#define NO_IMGUIHELPER_SERIALIZATION_LOAD
...
//--------------------------------------------------------------------------------
    ...
    protected:
        FieldInfo() {}
        void init (int _type=0,void* _pdata=NULL,const char* _label=NULL,const char* _tooltip=NULL,
...
struct NodeGraphEditor	{
    ...
    struct NodeCallback { virtual void operator() (Node*& node,NodeState state,NodeGraphEditor& editor) = 0; };
    struct LinkCallback { virtual void operator() (const NodeLink& link,LinkState state,NodeGraphEditor& editor) = 0; };
    ...
    struct Style {
        ...
        Style() {
            color_background =      ImColor(60,60,70,0);
